...
# [GCC 5.4.0 20160609]
# Embedded file name: ./AgentDefensive.py
# Compiled at: 2016-10-19 20:07:33
import sys
import pdb
import time
import random
...
class Agent:
    ...
    def evaluation_function(self):
        ...
        for idx in xrange(len(self.game.board)):
            ...
            elif len(self.game.board[idx]) > 0:
                walls_owned[self.game.board[idx][-1][0]] += 1

        flat_comp = tiles_owned[self.player] - tiles_owned[1 - self.player]
        return flat_comp - self.road_score(1 - self.player)
...
random_player = Agent()
# okay decompiling AgentDefensive.pyc
